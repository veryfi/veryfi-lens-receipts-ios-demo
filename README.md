...
![receipt-demo](https://github.com/veryfi/veryfi-lens-receipts-ios-demo/assets/2013102/029d15bf-9ff2-4e38-a8db-e72c7252cb9d)
...
```ruby
pod 'VeryfiLens-Receipts', '2.1.62.13'
```
...
- Delete `LensReceiptsDemo.xcworkspace` file
- Then open the regular project file `LensReceiptsDemo.xcodeproj` and follow the instructions below...
